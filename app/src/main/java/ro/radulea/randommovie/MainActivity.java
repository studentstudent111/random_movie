package ro.radulea.randommovie;
...
public class MainActivity extends AppCompatActivity {
    ...
    final static String API_KEY = "7c8ccf5d8c85a255a340130fdf0e40ab";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* final Button btnProgramList = findViewById(R.id.btnProgramList);
        ...
        btnMovieList.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                final int random = new Random().nextInt(600);
                connect(random);
    ...
    private void connect(int number) {
        ...
        Call<Movie> call = movieApiService.getMovie(number, API_KEY);
